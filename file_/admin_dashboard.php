...
<div class="container-fluid">
            ...
            <div class="card-widget border">
                <div class="profile-card">
                    ...
                    <div>
                        ...
                        <p class="text-muted small"><?php echo htmlspecialchars($userProfile['email']); ?></p>
                        <?php
                        $lastSeen = $adminController->getLastSeen($userId);
                        ?>
                        <p class="small opacity-75">
                            <span class="status-dot <?php echo $lastSeen ? 'offline' : 'online'; ?>"></span>
                            <?php echo $lastSeen ? 'Terakhir terlihat: ' . $lastSeen : 'Online'; ?>
                        </p>
                    </div>
                </div>
                <div class="d-flex justify-content-around mt-3 text-muted">
                    <?php
                    $following = count($adminController->getFollowing($userId)); // Yang direquest
                    $followers = count($adminController->getFollowers($userId)); // Yang merequest
                    ?>
                    <span title="Mengikuti"><i class="bi bi-person-plus fa-2s"></i>&nbsp;Following<br/><?php echo $following; ?></span>
                    <span title="Pengikut"><i class="bi bi-person-check"></i>&nbsp;Followers<br/><?php echo $followers; ?></span>
                 
                </div>
                <div class="mt-3 text-center">
                    <!-- <a href="index.php?page=chat" class="btn btn-primary btn-sm">Chat</a> -->
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card-widget border">
            ...
            <?php endforeach; ?>
            <a href="#" class="text-primary mt-2 d-block">Lihat semua undangan meeting <i
