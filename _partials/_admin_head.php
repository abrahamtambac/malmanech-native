                                        ...
                                        <div class="d-flex align-items-center position-relative">
                                            <div class="position-relative">
                                                <?php if ($unreadCount > 0): ?>
                                                    <img src="<?php echo $friendImage; ?>" class="rounded-circle me-2 profile-img" style="width: 35px; height: 35px;">
                                                    <span class="badge bg-primary rounded-pill position-absolute" style="top: -5px; right: -5px; font-size: 0.7em;border-width: thick;"><?php echo $unreadCount; ?></span>
                                                <?php else: ?>
                                                    <img src="<?php echo $friendImage; ?>" class="rounded-circle me-2 border border-primary" style="width: 35px; height: 35px;">
                                                <?php endif; ?>
                                            </div>
                                            <div class="flex-grow-1">
                                                <strong>   <?php echo htmlspecialchars($friend['name']); ?></strong>
                                                <span class="last-seen"><?php echo $lastSeen ? '<span class="status-dot offline"></span>Last seen: ' . $lastSeen : '<span class="status-dot online"></span>Online'; ?></span>
                                                <div class="latest-message text-muted small"><?php echo htmlspecialchars($latestMessage); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                    ...
                    <div class="chat-area">
                        <div class="chat-header">
                            <div class="d-flex align-items-center">
                                <img src="" class="rounded-circle me-2 profile-img" id="chat-header-img" style="width: 35px; height: 35px;">
                                <div>
                        ...
                        <div class="chat-messages" id="chat-messages">
                            <h4 class="text-muted text-center mt-5">
                                <i class="bi bi-fingerprint text-warning mt-5 text-center"></i><b> Malmanech</b><br/>Pilih teman untuk mulai mengobrol
                            </h4>
                        </div>
                        <div class="chat-input">
                            <div class="input-group">
                                <button class="btn btn-outline-primary" id="attach-btn"><i class="bi bi-paperclip"></i></button>
                                <input type="text" class="form-control border border-primary" id="message-input" placeholder="Ketik pesan...">
                        ...
                        <?php if (!empty($pendingRequests)): ?>
                            ...
                            ?>
                                <div class="d-flex justify-content-between align-items-center mb-2 p-2 border-bottom">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo $requestImage; ?>" class="rounded-circle me-2" style="width: 40px; height: 40px;">
                                        <span><?php echo htmlspecialchars($request['name']); ?></span>
                                    </div>
                                    <button class="btn btn-sm btn-success accept-friend-btn" data-user-id="<?php echo $request['id']; ?>" data-user-name="<?php echo htmlspecialchars($request['name']); ?>">Terima</button>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
